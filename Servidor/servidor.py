...
"""
    ...
    PORT: No recomiendo cambiarlo, pero aun esta a su disposicion cambiarlo
...
"""
   ...
   conectar
    ...
    generar_id
    Asigna a cada usuario un id numerico, se usa para identificar al jugador internamente
